...
-- vimwiki
-- For some reason this must come before lazy
vim.g.vimwiki_list = {
  {
    path = '~/code/vimwiki',
    syntax = 'markdown',
...
require('lazy').setup({
  ...
  'alexghergh/nvim-tmux-navigation', -- Tmux navigation between neovim and tmux

  'kylechui/nvim-surround', -- surrounding changes

  'vim-test/vim-test', -- Testing

  'tpope/vim-dispatch', -- Dispatch runner

  'tpope/vim-rails', -- Rails development

  'tpope/vim-rake', -- Ruby development

  'tpope/vim-bundler', -- Ruby and Rails Bundle Development
...
-- <tab>/<BS> indent/deindent for tabs/bs at end of line
vim.o.smarttab = true

-- Use 'shiftwidth' for tabs/bs at end of line
vim.o.softtabstop = -1
...
-- '.h' -- don't sort header files at lower priority
vim.opt.suffixes = vim.opt.suffixes
