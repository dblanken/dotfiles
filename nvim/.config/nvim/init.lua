...
require('packer').startup(function(use)
  ...
  use 'tpope/vim-rake'
  use 'vim-test/vim-test' -- Rails testing
  -- Tools I love
  use 'tpope/vim-eunuch' -- Easy file manipulation
  use 'tpope/vim-unimpaired' -- Easy traversal of files
  use 'tpope/vim-dispatch'  -- For testing and quickfix population
  use 'tpope/vim-surround'  -- Why this isn't here by default I don't know
