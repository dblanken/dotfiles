...
vim.g.python_host_prog = vim.fn.expand('~/.asdf/shims/python2')
vim.g.python3_host_prog = vim.fn.expand('~/.asdf/shims/python3')
vim.g.ruby_host_prog = vim.fn.expand('~/.asdf/shims/neovim-ruby-host')
vim.g.node_host_prog = vim.fn.expand('~/.config/yarn/global/node_modules/neovim/bin/cli.js')
vim.g.perl_host_prog = vim.fn.expand('~/.asdf/shims/perl')
