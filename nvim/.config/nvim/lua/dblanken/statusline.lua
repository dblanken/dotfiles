vim.cmd([[
hi link ELNormal Normal
hi link ELNormalOperatorPending Normal
hi link ELInsert Insert
hi link ElInsertCompletion Insert
hi link ELVisual Visual
hi link ELVisualLine Visual
hi link ELVisualBlock Visual
]])
