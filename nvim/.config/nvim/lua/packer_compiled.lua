...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-nvim-lsp", "cmp-treesitter", "cmp-nvim-lua", "cmp-path", "cmp-rg" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-pandoc', 'vim-pandoc-syntax', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'emmet-vim', 'vim-ragtag', 'vim-test', 'vim-dispatch'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType erb ++once lua require("packer.load")({'vim-dispatch'}, { ft = "erb" }, _G.packer_plugins)]]
vim.cmd [[au FileType rails ++once lua require("packer.load")({'vim-rails', 'vim-rake', 'vim-ruby-refactoring', 'vim-test', 'splitjoin.vim', 'vim-bundler', 'vim-dispatch'}, { ft = "rails" }, _G.packer_plugins)]]
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-rails', 'vim-rake', 'vim-ruby-refactoring', 'vim-test', 'splitjoin.vim', 'vim-bundler', 'vim-dispatch'}, { ft = "ruby" }, _G.packer_plugins)]]
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-pandoc', 'vim-pandoc-syntax', 'markdown-preview.nvim'}, { ft = "vimwiki" }, _G.packer_plugins)]]
vim.cmd [[au FileType eruby ++once lua require("packer.load")({'emmet-vim', 'vim-ragtag', 'vim-rails', 'vim-rake', 'vim-test', 'vim-bundler'}, { ft = "eruby" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-unimpaired', 'tabular', 'vimwiki', 'vim-fugitive'}, { event = "VimEnter *" }, _G.packer_plugins)]]
