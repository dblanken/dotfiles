...
time("Condition for { 'vim-rails' }", true)
if
try_loadstring("\27LJ\2\n}\0\0\3\0\5\0\0206\0\0\0009\0\1\0009\0\2\0'\2\3\0B\0\2\2)\1\0\0\0\1\0\0X\0\n€6\0\0\0009\0\1\0009\0\2\0'\2\4\0B\0\2\2)\1\0\0\0\1\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\14config.ru\fGemfile\17filereadable\afn\bvim\0", "condition", '{ "vim-rails" }')
then
time("Condition for { 'vim-rails' }", false)
...
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Gbrowse lua require("packer.load")({'vim-fugitive', 'vim-rhubarb'}, { cmd = "Gbrowse", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-textobj-rubyblock', 'vim-endwise', 'vim-rake', 'vim-ruby-refactoring'}, { ft = "ruby" }, _G.packer_plugins)]]
