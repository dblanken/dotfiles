...
_G.packer_plugins = {
  ...
  gruvbox = {
    after = { "vim-transparent", "galaxyline.nvim", "nvim-web-devicons" },
    loaded = true,
    only_config = true
  },
  ["lspsaga.nvim"] = {
  ...
  ["vim-textobj-user"] = {
    after = { "vim-textobj-entire", "vim-textobj-line", "vim-textobj-rubyblock", "vim-textobj-syntax", "vim-textobj-indent", "CamelCaseMotion" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-bundler', 'vim-commentary', 'vim-rails', 'vim-repeat', 'vim-surround', 'vim-textobj-user', 'vim-unimpaired', 'vim-tmux-navigator', 'vim-rake', 'vim-eunuch', 'vim-vinegar'}, { event = "VimEnter *" }, _G.packer_plugins)]]
