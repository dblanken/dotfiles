...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-rake', 'vim-repeat', 'vim-surround', 'vim-tmux-navigator', 'vim-vinegar', 'vim-bundler', 'vim-commentary', 'nord.nvim', 'vim-eunuch', 'vim-textobj-user', 'vim-rails', 'vim-unimpaired'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-abolish', 'vim-fugitive'}, { event = "BufEnter *" }, _G.packer_plugins)]]
