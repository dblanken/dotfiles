...
Personal development standards for personal projects.
...
- `owasp-security.md` — OWASP Top 10 prevention with JS/Python examples
...
## Notes
- Personal projects; no client or employer constraints
- Project-specific conventions are handled by project-level CLAUDE.md files or specialized skills

## Applied Learning
When something fails repeatedly, when I have to re-explain, or when a workaround is found for a platform/tool limitation, add a one-line bullet here. Keep each bullet under 15 words. No explanations. Only add things that will save time in future sessions.
